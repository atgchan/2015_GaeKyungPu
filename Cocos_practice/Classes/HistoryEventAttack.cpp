...
void HistoryEventAttack::Run()
{
	...
	ActionInterval* moveTo = MoveTo::create(1, Vec2(_Defender->getCurrentTile()->getPositionX() + 80, _Defender->getCurrentTile()->getPositionY() + 60));
	ActionInterval* recover = MoveTo::create(1, Vec2(_CurrentX, _CurrentY));
